  ...
  return (
    ...
    >
      ...
      <motion.div className="relative group cursor-pointer" whileHover="hover">
        ...
        />
        <motion.div
          className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-center gap-4 
      ...
      {/* Persistent Links for Small Screens */}
      <div className="flex md:hidden justify-center gap-4 mt-2 py-4">
        <a
          href={project.demoUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 bg-neon-pink rounded-full text-white hover:shadow-lg hover:shadow-neon-pink/50 transition-shadow"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 bg-neon-cyan rounded-full text-white hover:shadow-lg hover:shadow-neon-cyan/50 transition-shadow"
        >
